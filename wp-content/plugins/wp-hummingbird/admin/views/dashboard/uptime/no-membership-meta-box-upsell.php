		...
		<div class="sui-notice sui-notice-purple">
			<div class="sui-notice-content">
				<div class="sui-notice-message">
					...
					<p><a class="sui-button sui-button-purple" target="_blank" href="<?php echo esc_url( Utils::get_link( 'plugin', 'hummingbird_dash_uptime_upsell_link' ) ); ?>" onclick="window.wphbMixPanel.trackHBUpsell( 'uptime', 'dash_widget', 'cta_clicked', this.href, 'hb_uptime_upsell' );">
