...
use Smush_Vendor\GuzzleHttp\Cookie\CookieJar;
use Smush_Vendor\GuzzleHttp\Exception\GuzzleException;
use Smush_Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \Smush_Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
